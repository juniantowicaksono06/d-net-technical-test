    ...
    return (
        <React.Fragment>
                    ...
                    <div className="w-full md:w-1/2">
                        ...
                        <Formik 
                            ...
                            onSubmit={async(values, {resetForm}) => {
                                ...
                                setIsLoading(true);
                                const response = await fetch(`${import.meta.env.VITE_BASE_URL as string}/api/v1/register`, {
                                    method: "POST",
            ...
            <ImageCropper isOpen={openCropper} imageUrl={imageUrl} closeCropper={() => setOpenCropper(false)} uploadImage={async (file: Blob | null) => {
                ...
                const response = await fetch(`${import.meta.env.VITE_BASE_URL as string}/api/v1/upload_image`, {
                    method: "POST",
                    body: formData
                });
                setIsLoading(true);
